...
4. [Обработка категориальных признаков](#обработка-категориальных-признаков)
5. [Масштабирование данных](#масштабирование-данных)
6. [Разделение на тренировочную и тестовую выборки](#разделение-на-тренировочную-и-тестовую-выборки)
