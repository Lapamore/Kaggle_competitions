...
## Оценка и результаты
Следующим этапом работы стала загрузка `Titanic prediction.csv` на платформу Kaggle, где я оценил точность своей модели предсказания на тестовой выборке и участвовал в соревновании.
